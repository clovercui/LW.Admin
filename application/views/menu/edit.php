                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="icon" type="text" class="form-control"
                                           value="<?= $info['icon'] ?>" placeholder="请输入菜单图标（必填）">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="sort" type="text" class="form-control" value="<?= $info['sort'] ?>"
                                           placeholder="请输入菜单排序（必填）">
                                </div>
                            </div>
                        </div>
                    </div><!-- ./box-body -->
...
<script>
    $(function () {
        ...
        Utils.formValidate(form, rules, function () {
            Utils.formAjax(form, {
                url: "<?=site_url('menu/edit/'.$info['id'])?>",
